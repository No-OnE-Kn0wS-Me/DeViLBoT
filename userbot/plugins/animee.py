...
@borg.on(admin_cmd(pattern=r"meks"))
async def action(event):
    if event.fwd_from:
        return   
    number_of_times = event.text[7:]
...
@borg.on(admin_cmd(pattern=r"romnd"))
async def action(event):
    if event.fwd_from:
        return   
...
@borg.on(admin_cmd(pattern=r"isekd"))
async def action(event):
    if event.fwd_from:
        return   
...
@borg.on(admin_cmd(pattern=r"advntr"))
async def action(event):
    if event.fwd_from:
        return   
